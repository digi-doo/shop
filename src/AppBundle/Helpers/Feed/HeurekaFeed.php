...
final class HeurekaFeed
{
     ...
     */
    public function addProductVariant(ProductVariantInterface $prodVar, HeurekaFeedHelper $feedHelper): void
    {
        // Main parent product
        ...
        // Product name
        $feedHelper->addCData('PRODUCTNAME', $prod->getName());
