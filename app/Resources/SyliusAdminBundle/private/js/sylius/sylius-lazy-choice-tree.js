            ...
            var bindCheckboxAction = function (checkboxElement) {
                checkboxElement.checkbox({
                    onChecked: function() {
                        ...
                        var $el = $(this);
                        if ($el.is(':checked')) {
                            var $autoCheck = $el.parents('.item:first').parents('.item:first');
                            var $check = $autoCheck.find('input[name="productTaxon"]:first');
                            if (!$check.is(':checked')) $check.next('label').trigger('click');
                        }
