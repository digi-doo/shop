 ...
 */
class Version20180403121115 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_tag ADD main_tag TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE sylius_tag DROP main_tag');
    }
}
